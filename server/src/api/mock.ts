import {TProduct, TRestaurant, TReview, TUsers} from '../model/backendModel';

const normalizedRestaurants: Array<TRestaurant> = [
  {
...
const normalizedProducts: Array<TProduct> = [
  {
...
const normalizedReviews: Array<TReview> = [
  {
...
const normalizedUsers: Array<TUsers> = [
  {
